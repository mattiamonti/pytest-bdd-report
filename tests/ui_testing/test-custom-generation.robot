...
Verify a report with all tests passed in a feature
    ...
    common.Check Report Statistics   total_executed=2    total_passed=2 
...
Verify a report with all tests failed in a feature
    ...
    Open Report In Browser    ${url} 
    Wait Until Page Contains    ${report_title}
    common.Check Report Statistics    total_executed=2    total_failed=2
...
Verify a report with all tests skipped in a feature
    ...
    Open Report In Browser    ${url} 
    Wait Until Page Contains    ${report_title}
    common.Check Report Statistics    total_executed=3    total_skipped=2    total_passed=1
...
Verify a report with all tests skipped in multiple features
    ...
    Open Report In Browser    ${url} 
    Wait Until Page Contains    ${report_title}
    common.Check Report Statistics    total_executed=4    total_skipped=2    total_passed=2
...
Verify a report with passed and failed in a feature
    ...
    Open Report In Browser    ${url} 
    Wait Until Page Contains    ${report_title}
    common.Check Report Statistics    total_executed=2    total_failed=1    total_passed=1
...
Verify a report with passed and failed in multiple features
    ...
    Open Report In Browser    ${url} 
    Wait Until Page Contains    ${report_title}
    common.Check Report Statistics    total_executed=4    total_failed=2    total_passed=2
