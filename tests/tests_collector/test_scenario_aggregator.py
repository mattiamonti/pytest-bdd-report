...
def test_aggregated_steps_content(mock_steps_information):
    ...
    assert scenario_a_steps[0]['type'] == 'Given' and scenario_a_steps[0]['nodeid'] == 'node1'
    assert scenario_a_steps[1]['type'] == 'When' and scenario_a_steps[1]['nodeid'] == 'node2'
    assert scenario_a_steps[2]['type'] == 'Then' and scenario_a_steps[2]['nodeid'] == 'node3'
