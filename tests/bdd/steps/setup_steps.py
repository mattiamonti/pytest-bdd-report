...
def setup_report_with_failed_scenario(page: Page, generate_custom_bdd_report, cleanup_bdd_generated):
...
def setup_report_with_passed_scenario(page: Page, generate_custom_bdd_report, cleanup_bdd_generated):
...
def setup_report_with_multiple_failed_scenarios(page: Page, generate_custom_bdd_report, cleanup_bdd_generated):
    report_structure = {
        "Feature 1": {"passed": ["Passed 4"], "failed": ["Failed 1", "Failed 2", "Failed 3"]},
