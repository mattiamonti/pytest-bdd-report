...
Attach a text or json to a BDD Step in the HTML report generated by pytest-bdd-report, by using the provided attach.text_to_step() or attach.json_to_step() methods.
